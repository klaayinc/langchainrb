    ...
    describe "tool execution failure handling" do
      ...
      context "when tool execution raises an error" do
        ...
        it "adds error message as tool response" do
          ...
          expect(error_message.content).to eq("Error running tool (langchain_tool_calculator): Tool execution failed")
      ...
      context "when tool execution raises ArgumentError" do
        ...
        it "handles ArgumentError and continues conversation" do
          ...
          error_message = subject.messages.last
          expect(error_message.content).to eq("Error running tool (langchain_tool_calculator): Invalid input provided")
        end
      end
      ...
      context "when tool execution raises RuntimeError" do
        ...
        it "handles RuntimeError and continues conversation" do
          ...
          error_message = subject.messages.last
          expect(error_message.content).to eq("Error running tool (langchain_tool_calculator): Network timeout")
        end
      end
      ...
      context "when tool is not found" do
        ...
        it "handles tool not found error and continues conversation" do
          ...
          error_message = subject.messages.last
          expect(error_message.content).to eq("Error running tool (unknown_tool): Tool: unknown_tool not found in assistant.tools")
        end
      end
      ...
      context "when multiple tool calls fail" do
        ...
        it "handles multiple tool failures and continues conversation" do
          ...
          expect(error_messages[0].content).to eq("Error running tool (langchain_tool_calculator): Tool execution failed")
          expect(error_messages[0].tool_call_id).to eq("call_1")
          expect(error_messages[1].content).to eq("Error running tool (langchain_tool_calculator): Tool execution failed")
